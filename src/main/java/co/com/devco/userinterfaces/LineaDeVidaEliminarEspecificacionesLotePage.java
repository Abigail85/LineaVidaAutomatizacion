...
public class LineaDeVidaEliminarEspecificacionesLotePage {
	public static final Target ELIMINAR_ESPECIFICACION= Target.the("le da click a la opción de eliminar").located(By.xpath("//a[@data-id='1']//i[contains(@class, 'fas fa-trash')]"));
